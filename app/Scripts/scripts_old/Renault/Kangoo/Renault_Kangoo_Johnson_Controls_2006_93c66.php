...
class Renault_Kangoo_Johnson_Controls_2006_93c66 extends Script
{
    public function getResult()
    {
        $hex = $this->getByteForPosition('70', 14) . $this->getByteForPosition('70', 13). $this->getByteForPosition('70', 12);
        $number = hexdec($hex);
