...
class Suzuki_XL7_93c66 extends Script
{
    public function getResult()
    {
        $hex = $this->getByteForPosition('C0', 5) . $this->getByteForPosition('C0', 4). $this->getByteForPosition('C0', 3). $this->getByteForPosition('C0', 2);
        $number = hexdec($hex);
