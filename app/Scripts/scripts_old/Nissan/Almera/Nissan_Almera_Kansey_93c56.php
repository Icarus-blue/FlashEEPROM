...
class Nissan_Almera_Kansey_93c56 extends Script
{
    ...
    public function calculate(int $value)
    {
        ...
        return [
            ...
            ['row' => 'A0', 'cell' => 4, 'value' => substr($hex, 8, 2)],
            ['row' => 'A0', 'cell' => 5, 'value' => substr($hex, 10, 2)],
            ['row' => 'A0', 'cell' => 6, 'value' => substr($hex, 12, 2)],
            ['row' => 'A0', 'cell' => 7, 'value' => substr($hex, 14, 2)],
            ['row' => 'A0', 'cell' => 10, 'value' => substr($hex, 16, 2)],
            ['row' => 'A0', 'cell' => 11, 'value' => substr($hex, 18, 2)],
            ['row' => 'A0', 'cell' => 12, 'value' => substr($hex, 20, 2)],
            ['row' => 'A0', 'cell' => 13, 'value' => substr($hex, 22, 2)],
