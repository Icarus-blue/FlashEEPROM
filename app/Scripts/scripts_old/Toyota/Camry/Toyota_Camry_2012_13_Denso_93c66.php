...
class Toyota_Camry_2012_13_Denso_93c66 extends Script
{
    public function getResult()
    {
        $result = '';
        
        $hex = $this->getByteForPosition('00', 5) . $this->getByteForPosition('00',4)
            . $this->getByteForPosition('00', 3) . $this->getByteForPosition('00', 2);
