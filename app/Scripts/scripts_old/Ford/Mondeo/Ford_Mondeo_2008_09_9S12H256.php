...
class Ford_Mondeo_2008_09_9S12H256 extends Script
{
    ...
    public function calculate(int $value)
    {
        ...
        return [
            ...
            ['row' => 'EF0', 'cell' => 0, 'value' => substr($hex, 0, 2)],
            ['row' => 'EF0', 'cell' => 1, 'value' => substr($hex, 2, 2)],
            ...
            ['row' => 'EE0', 'cell' => 4, 'value' => substr($hex, 0, 2)],
            ['row' => 'EE0', 'cell' => 5, 'value' => substr($hex, 2, 2)],
            ...
            ['row' => 'EE0', 'cell' => 8, 'value' => substr($hex, 0, 2)],
            ['row' => 'EE0', 'cell' => 9, 'value' => substr($hex, 2, 2)],
            ...
            ['row' => 'EE0', 'cell' => 12, 'value' => substr($hex, 0, 2)],
            ['row' => 'EE0', 'cell' => 13, 'value' => substr($hex, 2, 2)],
