...
class Citroen_Berlingo_BSI_95160_V1 extends Script
{
    
    public function getResult()
    {
        $hex = $this->getByteForPosition('110', 8) . $this->getByteForPosition('110', 7) . $this->getByteForPosition('110', 6) . $this->getByteForPosition('110', 5);
        $number = hexdec($hex);
