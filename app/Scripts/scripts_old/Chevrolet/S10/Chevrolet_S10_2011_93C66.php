...
class Chevrolet_S10_2011_93C66 extends Script
{
    ...
    {   
        ...
        return
         [
            ...
            ['row' => '1F0', 'cell' => 6, 'value' => substr($hex, 0, 2)],
            ['row' => '1F0', 'cell' => 7, 'value' => substr($hex, 2, 2)],
            ['row' => '1F0', 'cell' => 8, 'value' => substr($hex, 0, 2)],
            ['row' => '1F0', 'cell' => 9, 'value' => substr($hex, 2, 2)],
            ['row' => '1F0', 'cell' => 10, 'value' => substr($hex, 0, 2)],
            ['row' => '1F0', 'cell' => 11, 'value' => substr($hex, 2, 2)],
