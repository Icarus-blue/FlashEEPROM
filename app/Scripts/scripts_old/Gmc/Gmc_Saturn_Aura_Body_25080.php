...
class Gmc_Saturn_Aura_Body_25080 extends Script
{
    public function getResult()
    {
        $hex = $this->getByteForPosition('3B0', 12) . $this->getByteForPosition('3B0',13). $this->getByteForPosition('3B0',10). $this->getByteForPosition('3B0',11);
        $number = hexdec($hex);
