...
class Suzuki_Gixxer_2019_93c66 extends Script
{
    public function getResult()
    {
        $hex = $this->getByteForPosition('A0', 0) . $this->getByteForPosition('A0', 1);
        $number = hexdec($hex);
    ...
    {   
        ...
        return
         [
            ...
            ['row' => 'A0', 'cell' => 3, 'value' => substr($hex2, 2, 2)],
            ...
            ['row' => 'A0', 'cell' => 15, 'value' => substr($hex2, 2, 2)],
            ...
            ['row' => 'B0', 'cell' => 11, 'value' => substr($hex2, 2, 2)],
            ...
            ['row' => 'C0', 'cell' => 7, 'value' => substr($hex2, 2, 2)],
            ...
            ['row' => 'C0', 'cell' => 14, 'value' => substr($hex2,0, 2)],
            ['row' => 'C0', 'cell' => 15, 'value' => substr($hex2, 2, 2)],

            ['row' => 'D0', 'cell' => 0, 'value' => substr($hex, 0, 2)],
            ['row' => 'D0', 'cell' => 1, 'value' => substr($hex, 2, 2)],
            ['row' => 'D0', 'cell' => 2, 'value' => substr($hex2,0, 2)],
            ['row' => 'D0', 'cell' => 3, 'value' => substr($hex2, 2, 2)],
            ...
            ['row' => 'D0', 'cell' => 11, 'value' => substr($hex2, 2, 2)],
