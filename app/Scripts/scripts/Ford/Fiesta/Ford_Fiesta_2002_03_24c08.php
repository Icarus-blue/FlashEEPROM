...
class Ford_Fiesta_2002_03_24c08 extends Script
{
    ...
    {   $result = (($value/15.77038322031225));
        ...
        return
         [
            ...
            ['row' => '160', 'cell' => 12, 'value' => substr($hex, 0, 2)],
            ['row' => '160', 'cell' => 11, 'value' => substr($hex, 2, 2)],
            ['row' => '170', 'cell' => 0, 'value' => substr($hex, 0, 2)],
            ['row' => '160', 'cell' => 15, 'value' => substr($hex, 2, 2)],

            ['row' => '170', 'cell' => 4, 'value' => substr($hex, 0, 2)],
            ['row' => '170', 'cell' => 3, 'value' => substr($hex, 2, 2)],
