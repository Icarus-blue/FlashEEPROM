...
class Honda_Crv_2002_93c56  extends Script
{
    public function getResult()
    {
        $hex = $this->getByteForPosition('E0', 2) . $this->getByteForPosition('E0', 3);
        $number = hexdec($hex);
    ...
    {   
        ...
        return
         [
            ['row' => 'E0', 'cell' => 0, 'value' => substr($hex2, 0, 2)],
            ['row' => 'E0', 'cell' => 1, 'value' => substr($hex2, 2, 2)],
            ['row' => 'E0', 'cell' => 2, 'value' => substr($hex, 0, 2)],
            ['row' => 'E0', 'cell' => 3, 'value' => substr($hex, 2, 2)],
            ['row' => 'E0', 'cell' => 4, 'value' => substr($hex2, 0, 2)],
            ['row' => 'E0', 'cell' => 5, 'value' => substr($hex2, 2, 2)],
            ...
            ['row' => 'E0', 'cell' => 12, 'value' => substr($hex2, 0, 2)],
            ['row' => 'E0', 'cell' => 13, 'value' => substr($hex2, 2, 2)],
            ['row' => 'E0', 'cell' => 14, 'value' => substr($hex, 0, 2)],
            ['row' => 'E0', 'cell' => 15, 'value' => substr($hex, 2, 2)],

            ['row' => 'F0', 'cell' => 0, 'value' => substr($hex2, 0, 2)],
            ['row' => 'F0', 'cell' => 1, 'value' => substr($hex2, 2, 2)],
            ['row' => 'F0', 'cell' => 2, 'value' => substr($hex, 0, 2)],
            ['row' => 'F0', 'cell' => 3, 'value' => substr($hex, 2, 2)],
            ['row' => 'F0', 'cell' => 4, 'value' => substr($hex2, 0, 2)],
            ['row' => 'F0', 'cell' => 5, 'value' => substr($hex2, 2, 2)],
            ['row' => 'F0', 'cell' => 6, 'value' => substr($hex, 0, 2)],
            ['row' => 'F0', 'cell' => 7, 'value' => substr($hex, 2, 2)],
            ['row' => 'F0', 'cell' => 8, 'value' => substr($hex2, 0, 2)],
            ['row' => 'F0', 'cell' => 9, 'value' => substr($hex2, 2, 2)],
            ['row' => 'F0', 'cell' => 10, 'value' => substr($hex, 0, 2)],
            ['row' => 'F0', 'cell' => 11, 'value' => substr($hex, 2, 2)],
            ['row' => 'F0', 'cell' => 12, 'value' => substr($hex2, 0, 2)],
            ['row' => 'F0', 'cell' => 13, 'value' => substr($hex2, 2, 2)],
