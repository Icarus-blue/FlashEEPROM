...
class honda_Civic_2012_13_93c76 extends Script
{
    ...
    {   
        ...
        return
         [
            ...
            ['row' => '200', 'cell' => 8, 'value' => substr($hex2, 2, 2)],
            ['row' => '200', 'cell' => 9, 'value' => substr($hex2, 0, 2)],
            ['row' => '200', 'cell' => 10, 'value' => substr($hex, 2, 2)],
            ['row' => '200', 'cell' => 11, 'value' => substr($hex, 0, 2)],
            ['row' => '200', 'cell' => 12, 'value' => substr($hex2, 2, 2)],
            ['row' => '200', 'cell' => 13, 'value' => substr($hex2, 0, 2)],
            ['row' => '200', 'cell' => 14, 'value' => substr($hex, 2, 2)],
            ['row' => '200', 'cell' => 15, 'value' => substr($hex, 0, 2)],

            ['row' => '210', 'cell' => 0, 'value' => substr($hex2, 2, 2)],
            ['row' => '210', 'cell' => 1, 'value' => substr($hex2, 0, 2)],
            ['row' => '210', 'cell' => 2, 'value' => substr($hex, 2, 2)],
            ['row' => '210', 'cell' => 3, 'value' => substr($hex, 0, 2)],
            ['row' => '210', 'cell' => 4, 'value' => substr($hex2, 2, 2)],
            ['row' => '210', 'cell' => 5, 'value' => substr($hex2, 0, 2)],
            ['row' => '210', 'cell' => 6, 'value' => substr($hex, 2, 2)],
            ['row' => '210', 'cell' => 7, 'value' => substr($hex, 0, 2)],
