...
class Mazda_BT50_2011_13_24c16 extends Script
{
    ...
    public function calculate(int $value)
    {
        switch ($value) {
            case  1000:
                ...
                break;
                case  77123:
                $hex='DF07C00F801F003F007E00FC01F803F007E00FC01F803F007E00FC00F801F003';
                break;
                 case  68700:
                $hex='45E48BC817912F225E44BC887911F222E445C88B9117222F445E88BC117922F2';
                break;
                case  78525:
        ...
        return [
            ...
            ['row' => '520', 'cell' => 6, 'value' => substr($hex2, 0, 2)],
            ['row' => '520', 'cell' => 7, 'value' => substr($hex2, 2, 2)],
