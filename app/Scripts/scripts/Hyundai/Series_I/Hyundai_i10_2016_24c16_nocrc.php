...
class Hyundai_i10_2016_24c16_nocrc extends Script

{
    public function getResult()
    { $byte = $this->getByteForPosition('780', 11);
        
        $a = substr($byte, 0, 1);
        $b =substr($byte, -1);

        $byte2=$this->getByteForPosition('780', 12);
        $c = substr($byte2, 0, 1);
     
       
         
         $hexx = $this->getByteForPosition('780', 13) ;
         $hexx4 = hexdec($hexx);
         switch ($hexx4) 
         {
