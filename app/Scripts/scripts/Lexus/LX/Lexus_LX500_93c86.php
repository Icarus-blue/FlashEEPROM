...
class Lexus_LX500_93c86 extends Script
{
    ...
    {   $result = (($value/25));
        ...
        return
         [
            ...
            ['row' => '40', 'cell' => 4, 'value' => substr($hex2, 0, 2)],
            ['row' => '40', 'cell' => 5, 'value' => substr($hex2, 2, 2)],
            ['row' => '40', 'cell' => 6, 'value' => substr($hex2, 0, 2)],
            ['row' => '40', 'cell' => 7, 'value' => substr($hex2, 2, 2)],
            ['row' => '40', 'cell' => 8, 'value' => substr($hex2, 0, 2)],
            ['row' => '40', 'cell' => 9, 'value' => substr($hex2, 2, 2)],
            ['row' => '40', 'cell' => 10, 'value' => substr($hex2, 0, 2)],
            ['row' => '40', 'cell' => 11, 'value' => substr($hex2, 2, 2)],
            ['row' => '40', 'cell' => 12, 'value' => substr($hex2, 0, 2)],
            ['row' => '40', 'cell' => 13, 'value' => substr($hex2, 2, 2)],
            ['row' => '40', 'cell' => 14, 'value' => substr($hex2, 0, 2)],
            ['row' => '40', 'cell' => 15, 'value' => substr($hex2, 2, 2)],
            
            ['row' => '50', 'cell' => 0, 'value' => substr($hex2, 0, 2)],
            ['row' => '50', 'cell' => 1, 'value' => substr($hex2, 2, 2)],
            ['row' => '50', 'cell' => 2, 'value' => substr($hex2, 0, 2)],
            ['row' => '50', 'cell' => 3, 'value' => substr($hex2, 2, 2)],
            ['row' => '50', 'cell' => 4, 'value' => substr($hex2, 0, 2)],
            ['row' => '50', 'cell' => 5, 'value' => substr($hex2, 2, 2)],
            ['row' => '50', 'cell' => 6, 'value' => substr($hex2, 0, 2)],
            ['row' => '50', 'cell' => 7, 'value' => substr($hex2, 2, 2)],
            ['row' => '50', 'cell' => 8, 'value' => substr($hex2, 0, 2)],
            ['row' => '50', 'cell' => 9, 'value' => substr($hex2, 2, 2)],
            ['row' => '50', 'cell' => 10, 'value' => substr($hex2, 0, 2)],
            ['row' => '50', 'cell' => 11, 'value' => substr($hex2, 2, 2)],
            ['row' => '50', 'cell' => 12, 'value' => substr($hex2, 0, 2)],
            ['row' => '50', 'cell' => 13, 'value' => substr($hex2, 2, 2)],
            ['row' => '50', 'cell' => 14, 'value' => substr($hex2, 0, 2)],
            ['row' => '50', 'cell' => 15, 'value' => substr($hex2, 2, 2)],
