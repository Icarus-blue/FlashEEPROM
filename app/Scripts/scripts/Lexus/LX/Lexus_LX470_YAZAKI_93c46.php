...
class Lexus_LX470_YAZAKI_93c46 extends Script
{
    ...
    {   
        ...
        return
         [
            ...
            ['row' => '30', 'cell' => 4, 'value' => substr($hex, 0, 2)],
            ['row' => '30', 'cell' => 5, 'value' => substr($hex, 2, 2)],
            ...
            ['row' => '40', 'cell' => 12, 'value' => substr($hex, 0, 2)],
            ['row' => '40', 'cell' => 13, 'value' => substr($hex, 2, 2)],
            ...
            ['row' => '50', 'cell' => 13, 'value' => substr($hex, 2, 2)],
