...
class Isuzu_Dmax_93c66_2017  extends Script
{
    ...
    {   $result = (($value/22.5));
        ...
        $result2 = ((00));
        $hex4 = str_pad(dechex($result2), 4, '0', STR_PAD_LEFT);
        return
         [
            ...
            ['row' => '30', 'cell' => 0, 'value' => substr($hex4, 2, 2)],
            ['row' => '30', 'cell' => 1, 'value' => substr($hex4, 0, 2)],
            ['row' => '30', 'cell' => 2, 'value' => substr($hex4, 2, 2)],
            ['row' => '30', 'cell' => 3, 'value' => substr($hex4, 0, 2)],
            ['row' => '30', 'cell' => 4, 'value' => substr($hex4, 2, 2)],
            ['row' => '30', 'cell' => 5, 'value' => substr($hex4, 0, 2)],
            ['row' => '30', 'cell' => 6, 'value' => substr($hex4, 2, 2)],
            ['row' => '30', 'cell' => 7, 'value' => substr($hex4, 0, 2)],
            ['row' => '30', 'cell' => 8, 'value' => substr($hex4, 2, 2)],
            ['row' => '30', 'cell' => 9, 'value' => substr($hex4, 0, 2)],
            ['row' => '30', 'cell' => 10, 'value' => substr($hex4, 2, 2)],
            ['row' => '30', 'cell' => 11, 'value' => substr($hex4, 0, 2)],
            ['row' => '30', 'cell' => 12, 'value' => substr($hex4, 2, 2)],
            ['row' => '30', 'cell' => 13, 'value' => substr($hex4, 0, 2)],
            ['row' => '30', 'cell' => 14, 'value' => substr($hex4, 2, 2)],
            ['row' => '30', 'cell' => 15, 'value' => substr($hex4, 0, 2)], 
        ];
    }
}
