...
class Renault_Modus_2005_93c56 extends Script
{
    ...
    {   $result = round(($value));
        ...
        return
         [
            ...
            ['row' => '00', 'cell' => 6, 'value' => substr($hex2, 6, 2)],
            ['row' => '00', 'cell' => 7, 'value' => substr($hex2, 4, 2)],
            ...
            ['row' => '10', 'cell' => 2, 'value' => substr($hex2, 6, 2)],
