...
class Renault_Laguna_2005_68HC12DG128A extends Script
{
    public function getResult()
    {
        $hex = $this->getByteForPosition('100',1). $this->getByteForPosition('100', 2) . $this->getByteForPosition('100',3);
        $number = hexdec($hex);
    ...
    {   $result = round(($value));
        ...
        return
         ...
         [
            ...
            ['row' => '100', 'cell' => 11, 'value' => substr($hex, 4, 2)],
            ...
            ['row' => '200', 'cell' => 7, 'value' => substr($hex, 4, 2)],
            ['row' => '200', 'cell' => 9, 'value' => substr($hex, 0, 2)],
            ['row' => '200', 'cell' => 10, 'value' => substr($hex, 2, 2)],
            ['row' => '200', 'cell' => 11, 'value' => substr($hex, 4, 2)],
            ['row' => '200', 'cell' => 13, 'value' => substr($hex, 0, 2)],
            ['row' => '200', 'cell' => 14, 'value' => substr($hex, 2, 2)],
            ['row' => '200', 'cell' => 15, 'value' => substr($hex, 4, 2)],
            ...
            ['row' => '170', 'cell' => 2, 'value' => substr($hex, 2, 2)],
            ['row' => '170', 'cell' => 3, 'value' => substr($hex, 4, 2)],
            ['row' => '170', 'cell' => 5, 'value' => substr($hex, 0, 2)],
            ['row' => '170', 'cell' => 6, 'value' => substr($hex, 2, 2)],
            ['row' => '170', 'cell' => 7, 'value' => substr($hex, 4, 2)],
            ['row' => '170', 'cell' => 9, 'value' => substr($hex, 0, 2)],
            ['row' => '170', 'cell' => 10, 'value' => substr($hex, 2, 2)],
            ['row' => '170', 'cell' => 11, 'value' => substr($hex, 4, 2)],
            ['row' => '170', 'cell' => 13, 'value' => substr($hex, 0, 2)],
            ['row' => '170', 'cell' => 14, 'value' => substr($hex, 2, 2)],
            ['row' => '170', 'cell' => 15, 'value' => substr($hex, 4, 2)],

            ['row' => '160', 'cell' => 1, 'value' => substr($hex, 0, 2)],
            ['row' => '160', 'cell' => 2, 'value' => substr($hex, 2, 2)],
            ['row' => '160', 'cell' => 3, 'value' => substr($hex, 4, 2)],
            ...
            ['row' => '160', 'cell' => 10, 'value' => substr($hex, 2, 2)],
            ['row' => '160', 'cell' => 11, 'value' => substr($hex, 4, 2)],
            ['row' => '160', 'cell' => 13, 'value' => substr($hex, 0, 2)],
            ['row' => '160', 'cell' => 14, 'value' => substr($hex, 2, 2)],
            ['row' => '160', 'cell' => 15, 'value' => substr($hex, 4, 2)],
            ...
            ['row' => '150', 'cell' => 6, 'value' => substr($hex, 2, 2)],
            ['row' => '150', 'cell' => 7, 'value' => substr($hex, 4, 2)],
            ['row' => '150', 'cell' => 9, 'value' => substr($hex, 0, 2)],
            ['row' => '150', 'cell' => 10, 'value' => substr($hex, 2, 2)],
            ['row' => '150', 'cell' => 11, 'value' => substr($hex, 4, 2)],
            ['row' => '150', 'cell' => 13, 'value' => substr($hex, 0, 2)],
            ['row' => '150', 'cell' => 14, 'value' => substr($hex, 2, 2)],
            ['row' => '150', 'cell' => 15, 'value' => substr($hex, 4, 2)],

            
            ['row' => '140', 'cell' => 1, 'value' => substr($hex, 0, 2)],
            ['row' => '140', 'cell' => 2, 'value' => substr($hex, 2, 2)],
            ['row' => '140', 'cell' => 3, 'value' => substr($hex, 4, 2)],
            ...
            ['row' => '140', 'cell' => 10, 'value' => substr($hex, 2, 2)],
            ['row' => '140', 'cell' => 11, 'value' => substr($hex, 4, 2)],
            ...
            ['row' => '120', 'cell' => 3, 'value' => substr($hex, 4, 2)],
            ...
            ['row' => '120', 'cell' => 15, 'value' => substr($hex, 4, 2)],
            ...
            ['row' => '110', 'cell' => 7, 'value' => substr($hex, 4, 2)],
            ['row' => '110', 'cell' => 9, 'value' => substr($hex, 0, 2)],
            ['row' => '110', 'cell' => 10, 'value' => substr($hex, 2, 2)],
            ['row' => '110', 'cell' => 11, 'value' => substr($hex, 4, 2)],
