...
class Volkswagen_touran_var1_24C16 extends Script
{
    public function getResult()
    {
        $hex = $this->getByteForPosition('D0', 1) . $this->getByteForPosition('D0', 0);
        $number = hexdec($hex);
    ...
    public function calculate(int $value)
    {
        ...
        return [
            ...
            ['row' => 'D0', 'cell' => 6, 'value' => substr($hex, 12, 2)],
            ['row' => 'D0', 'cell' => 7, 'value' => substr($hex, 14, 2)],
            ['row' => 'D0', 'cell' => 8, 'value' => substr($hex, 16, 2)],
            ['row' => 'D0', 'cell' => 9, 'value' => substr($hex, 18, 2)],
            ['row' => 'D0', 'cell' => 10, 'value' => substr($hex, 20, 2)],
            ['row' => 'D0', 'cell' => 11, 'value' => substr($hex, 22, 2)],
            ['row' => 'D0', 'cell' => 12, 'value' => substr($hex, 24, 2)],
            ['row' => 'D0', 'cell' => 13, 'value' => substr($hex, 26, 2)],
            ['row' => 'D0', 'cell' => 14, 'value' => substr($hex, 28, 2)],
            ['row' => 'D0', 'cell' => 15, 'value' => substr($hex, 30, 2)],
            
            ['row' => 'E0', 'cell' => 0, 'value' => substr($hex, 32, 2)],
            ['row' => 'E0', 'cell' => 1, 'value' => substr($hex, 34, 2)],
            ['row' => 'E0', 'cell' => 2, 'value' => substr($hex, 36, 2)],
            ['row' => 'E0', 'cell' => 3, 'value' => substr($hex, 38, 2)],
            ['row' => 'E0', 'cell' => 4, 'value' => substr($hex, 40, 2)],
            ['row' => 'E0', 'cell' => 5, 'value' => substr($hex, 42, 2)],
            ['row' => 'E0', 'cell' => 6, 'value' => substr($hex, 44, 2)],
            ['row' => 'E0', 'cell' => 7, 'value' => substr($hex, 46, 2)],
            ['row' => 'E0', 'cell' => 8, 'value' => substr($hex, 48, 2)],
            ['row' => 'E0', 'cell' => 9, 'value' => substr($hex, 50, 2)],
            ['row' => 'E0', 'cell' => 10, 'value' => substr($hex, 52, 2)],
            ['row' => 'E0', 'cell' => 11, 'value' => substr($hex, 54, 2)],
            ['row' => 'E0', 'cell' => 12, 'value' => substr($hex, 56, 2)],
            ['row' => 'E0', 'cell' => 13, 'value' => substr($hex, 58, 2)],
            ['row' => 'E0', 'cell' => 14, 'value' => substr($hex, 60, 2)],
            ['row' => 'E0', 'cell' => 15, 'value' => substr($hex, 62, 2)]
