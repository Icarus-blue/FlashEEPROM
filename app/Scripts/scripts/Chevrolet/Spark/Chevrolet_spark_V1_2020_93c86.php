...
class Chevrolet_spark_V1_2020_93c86 extends Script
{
    ...
    {  
        ...
        return
         [
            ...
            ['row' => '00', 'cell' => 1, 'value' => substr($hex, 6, 2)],
            ...
            ['row' => '10', 'cell' => 9, 'value' => substr($hex, 6, 2)],
            ['row' => '10', 'cell' => 10, 'value' => substr($hex, 0, 2)],
            ['row' => '10', 'cell' => 11, 'value' => substr($hex, 2, 2)],
            ['row' => '10', 'cell' => 12, 'value' => substr($hex, 4, 2)],
            ['row' => '10', 'cell' => 13, 'value' => substr($hex, 6, 2)],
            ...
            ['row' => '40', 'cell' => 5, 'value' => substr($hex, 6, 2)],
            ['row' => '40', 'cell' => 6, 'value' => substr($hex, 0, 2)],
            ['row' => '40', 'cell' => 7, 'value' => substr($hex, 2, 2)],
            
            ['row' => '50', 'cell' => 0, 'value' => substr($hex, 4, 2)],
            ['row' => '50', 'cell' => 1, 'value' => substr($hex, 6, 2)],
            ['row' => '50', 'cell' => 2, 'value' => substr($hex, 0, 2)],
            ['row' => '50', 'cell' => 3, 'value' => substr($hex, 2, 2)],
            ['row' => '50', 'cell' => 4, 'value' => substr($hex, 4, 2)],
            ['row' => '50', 'cell' => 5, 'value' => substr($hex, 6, 2)],
            ['row' => '50', 'cell' => 6, 'value' => substr($hex, 0, 2)],
            ['row' => '50', 'cell' => 7, 'value' => substr($hex, 2, 2)],
            ['row' => '50', 'cell' => 8, 'value' => substr($hex, 4, 2)],
            ['row' => '50', 'cell' => 9, 'value' => substr($hex, 6, 2)],
