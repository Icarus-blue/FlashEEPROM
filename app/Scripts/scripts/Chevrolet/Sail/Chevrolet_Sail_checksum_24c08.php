...
class Chevrolet_Sail_checksum_24c08 extends Script
{
    ...
    { $byte = $this->getByteForPosition('340', 4);
        
        $a = substr($byte, 0, 1);
        $b =substr($byte, -1);

        $byte2=$this->getByteForPosition('340', 5);
        $c = substr($byte2, 0, 1);
        $hex = $a . $b. $c ;
        $number = hexdec($hex); 
    ...
    private function calculateRepeatedValue(int $value) : array
    {
        ...
        return
         [
            ...
            ['row' => '340', 'cell' => 5, 'value' => substr($hex9, 0, 2)], 
            ['row' => '340', 'cell' => 8, 'value' => substr($hex2, 0, 2)],
            ['row' => '340', 'cell' => 9, 'value' => substr($hex9, 0, 2)], 
            ['row' => '340', 'cell' => 12, 'value' => substr($hex2, 0, 2)],
            ['row' => '340', 'cell' => 13, 'value' => substr($hex9, 0, 2)], 
            
            ['row' => '350', 'cell' => 0, 'value' => substr($hex2, 0, 2)],
            ['row' => '350', 'cell' => 1, 'value' => substr($hex9, 0, 2)], 
            ['row' => '350', 'cell' => 4, 'value' => substr($hex2, 0, 2)],
            ['row' => '350', 'cell' => 5, 'value' => substr($hex9, 0, 2)], 
            ['row' => '350', 'cell' => 8, 'value' => substr($hex2, 0, 2)],
            ['row' => '350', 'cell' => 9, 'value' => substr($hex9, 0, 2)],
            ['row' => '350', 'cell' => 12, 'value' => substr($hex2, 0, 2)],
            ['row' => '350', 'cell' => 13, 'value' => substr($hex9, 0, 2)], 
            
            ['row' => '360', 'cell' => 0, 'value' => substr($hex2, 0, 2)],
            ['row' => '360', 'cell' => 1, 'value' => substr($hex9, 0, 2)], 
            ['row' => '360', 'cell' => 4, 'value' => substr($hex2, 0, 2)],
            ['row' => '360', 'cell' => 5, 'value' => substr($hex9, 0, 2)], 
            ['row' => '360', 'cell' => 8, 'value' => substr($hex2, 0, 2)],
            ['row' => '360', 'cell' => 9, 'value' => substr($hex9, 0, 2)],
            ['row' => '360', 'cell' => 12, 'value' => substr($hex2, 0, 2)],
            ['row' => '360', 'cell' => 13, 'value' => substr($hex9, 0, 2)],
            
            ['row' => '370', 'cell' => 0, 'value' => substr($hex2, 0, 2)],
            ['row' => '370', 'cell' => 1, 'value' => substr($hex9, 0, 2)], 
            ['row' => '370', 'cell' => 4, 'value' => substr($hex2, 0, 2)],
            ['row' => '370', 'cell' => 5, 'value' => substr($hex9, 0, 2)], 
            ['row' => '370', 'cell' => 8, 'value' => substr($hex2, 0, 2)],
            ['row' => '370', 'cell' => 9, 'value' => substr($hex9, 0, 2)],
            ['row' => '370', 'cell' => 12, 'value' => substr($hex2, 0, 2)],
            ['row' => '370', 'cell' => 13, 'value' => substr($hex9, 0, 2)],
            
            ['row' => '380', 'cell' => 0, 'value' => substr($hex2, 0, 2)],
            ['row' => '380', 'cell' => 1, 'value' => substr($hex9, 0, 2)], 
            ['row' => '380', 'cell' => 4, 'value' => substr($hex2, 0, 2)],
            ['row' => '380', 'cell' => 5, 'value' => substr($hex9, 0, 2)], 
            ['row' => '380', 'cell' => 8, 'value' => substr($hex2, 0, 2)],
            ['row' => '380', 'cell' => 9, 'value' => substr($hex9, 0, 2)],
            ['row' => '380', 'cell' => 12, 'value' => substr($hex2, 0, 2)],
            ['row' => '380', 'cell' => 13, 'value' => substr($hex9, 0, 2)],
            
            
            ['row' => '390', 'cell' => 0, 'value' => substr($hex2, 0, 2)],
            ['row' => '390', 'cell' => 1, 'value' => substr($hex9, 0, 2)], 
            ['row' => '390', 'cell' => 4, 'value' => substr($hex2, 0, 2)],
            ['row' => '390', 'cell' => 5, 'value' => substr($hex9, 0, 2)], 
            ['row' => '390', 'cell' => 8, 'value' => substr($hex2, 0, 2)],
            ['row' => '390', 'cell' => 9, 'value' => substr($hex9, 0, 2)],
            ['row' => '390', 'cell' => 12, 'value' => substr($hex2, 0, 2)],
            ['row' => '390', 'cell' => 13, 'value' => substr($hex9, 0, 2)],
            
            ['row' => '3A0', 'cell' => 0, 'value' => substr($hex2, 0, 2)],
            ['row' => '3A0', 'cell' => 1, 'value' => substr($hex9, 0, 2)], 
            ['row' => '3A0', 'cell' => 4, 'value' => substr($hex2, 0, 2)],
            ['row' => '3A0', 'cell' => 5, 'value' => substr($hex9, 0, 2)], 
            ['row' => '3A0', 'cell' => 8, 'value' => substr($hex2, 0, 2)],
            ['row' => '3A0', 'cell' => 9, 'value' => substr($hex9, 0, 2)],
            ['row' => '3A0', 'cell' => 12, 'value' => substr($hex2, 0, 2)],
            ['row' => '3A0', 'cell' => 13, 'value' => substr($hex9, 0, 2)],
    ...
    public function calculate(int $value)
    {
        ...
        for ($i = 0; $i < 32; $i++) {
            $offset = $this->getOffset('340', 7, $i * 4);
