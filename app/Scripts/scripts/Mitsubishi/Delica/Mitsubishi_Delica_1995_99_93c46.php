...
class Mitsubishi_Delica_1995_99_93c46 extends Script
{
    ...
    public function calculate(int $value)
    {
        ...
        return [
            ...
            ['row' => '40', 'cell' => 12, 'value' => substr($hex, 8, 2)],
            ['row' => '40', 'cell' => 13, 'value' => substr($hex, 10, 2)],
            ['row' => '40', 'cell' => 14, 'value' => substr($hex, 12, 2)],
            ['row' => '40', 'cell' => 15, 'value' => substr($hex, 14, 2)],
