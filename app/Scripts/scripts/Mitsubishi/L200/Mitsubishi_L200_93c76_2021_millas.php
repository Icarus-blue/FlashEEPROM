...
class Mitsubishi_L200_93c76_2021_millas extends Script
{
    public function getResult()
    {
        ...
        return [
            'result' => round(((65535-$number)* 32)/1.60934),
    ...
    {   
        $result = round((65535-($value/32)*1.60934));
        $hex = str_pad(dechex($result), 4, '0', STR_PAD_LEFT);
        $result2 = round((($value/32)/1.6)*1.60934);
