...
class Mitsubishi_L200_2010_12_93c56 extends Script
{
    public function getResult()
    {
        $hex = $this->getByteForPosition('C0', 3) . $this->getByteForPosition('C0', 2);
        $number = hexdec($hex);
    ...
    {   
        ...
        return
         [
            ...
            ['row' => 'C0', 'cell' => 1, 'value' => substr($hex2, 0, 2)],
            ['row' => 'C0', 'cell' => 2, 'value' => substr($hex, 2, 2)],
            ['row' => 'C0', 'cell' => 3, 'value' => substr($hex, 0, 2)],
            ['row' => 'C0', 'cell' => 4, 'value' => substr($hex2, 2, 2)],
            ...
            ['row' => 'C0', 'cell' => 13, 'value' => substr($hex2, 0, 2)],
            ['row' => 'C0', 'cell' => 14, 'value' => substr($hex, 2, 2)],
            ['row' => 'C0', 'cell' => 15, 'value' => substr($hex, 0, 2)],

            ['row' => 'D0', 'cell' => 0, 'value' => substr($hex2, 2, 2)],
            ['row' => 'D0', 'cell' => 1, 'value' => substr($hex2, 0, 2)],
            ['row' => 'D0', 'cell' => 2, 'value' => substr($hex, 2, 2)],
            ['row' => 'D0', 'cell' => 3, 'value' => substr($hex, 0, 2)],
            ['row' => 'D0', 'cell' => 4, 'value' => substr($hex2, 2, 2)],
            ['row' => 'D0', 'cell' => 5, 'value' => substr($hex2, 0, 2)],
            ['row' => 'D0', 'cell' => 6, 'value' => substr($hex, 2, 2)],
            ['row' => 'D0', 'cell' => 7, 'value' => substr($hex, 0, 2)],
            ['row' => 'D0', 'cell' => 8, 'value' => substr($hex2, 2, 2)],
            ['row' => 'D0', 'cell' => 9, 'value' => substr($hex2, 0, 2)],
            ['row' => 'D0', 'cell' => 10, 'value' => substr($hex, 2, 2)],
            ['row' => 'D0', 'cell' => 11, 'value' => substr($hex, 0, 2)],
            ['row' => 'D0', 'cell' => 12, 'value' => substr($hex2, 2, 2)],
            ['row' => 'D0', 'cell' => 13, 'value' => substr($hex2, 0, 2)],
