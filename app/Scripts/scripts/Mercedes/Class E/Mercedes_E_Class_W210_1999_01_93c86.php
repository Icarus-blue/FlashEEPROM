...
class Mercedes_E_Class_W210_1999_01_93c86 extends Script
{
    ...
    public function calculate(int $value)
    {
        ...
        return [
            ...
            ['row' => '300', 'cell' => 0, 'value' => substr($hex, 0, 2)],
            ['row' => '300', 'cell' => 1, 'value' => substr($hex, 2, 2)],
            ['row' => '300', 'cell' => 2, 'value' => substr($hex, 4, 2)],
            ['row' => '300', 'cell' => 3, 'value' => substr($hex, 6, 2)],
            ['row' => '300', 'cell' => 4, 'value' => substr($hex, 8, 2)],
            ['row' => '300', 'cell' => 5, 'value' => substr($hex, 10, 2)],
            ['row' => '300', 'cell' => 6, 'value' => substr($hex, 12, 2)],
            ['row' => '300', 'cell' => 7, 'value' => substr($hex, 14, 2)],
            ['row' => '300', 'cell' => 8, 'value' => substr($hex, 16, 2)],
            ['row' => '300', 'cell' => 9, 'value' => substr($hex, 18, 2)],
            ['row' => '300', 'cell' => 10, 'value' => substr($hex, 20, 2)],
            ['row' => '300', 'cell' => 11, 'value' => substr($hex, 22, 2)],
            ['row' => '300', 'cell' => 12, 'value' => substr($hex, 24, 2)],
            ['row' => '300', 'cell' => 13, 'value' => substr($hex, 26, 2)],
            ['row' => '300', 'cell' => 14, 'value' => substr($hex, 28, 2)],
            ['row' => '300', 'cell' => 15, 'value' => substr($hex, 30, 2)],

            ['row' => '310', 'cell' => 0, 'value' => substr($hex, 32, 2)],
            ['row' => '310', 'cell' => 1, 'value' => substr($hex, 34, 2)],
            ['row' => '310', 'cell' => 2, 'value' => substr($hex, 36, 2)],
            ['row' => '310', 'cell' => 3, 'value' => substr($hex, 38, 2)],
            ['row' => '310', 'cell' => 4, 'value' => substr($hex, 40, 2)],
            ['row' => '310', 'cell' => 5, 'value' => substr($hex, 42, 2)],
            ['row' => '310', 'cell' => 6, 'value' => substr($hex, 44, 2)],
            ['row' => '310', 'cell' => 7, 'value' => substr($hex, 46, 2)],
            ['row' => '310', 'cell' => 8, 'value' => substr($hex, 48, 2)],
            ['row' => '310', 'cell' => 9, 'value' => substr($hex, 50, 2)],
            ['row' => '310', 'cell' => 10, 'value' => substr($hex, 52, 2)],
            ['row' => '310', 'cell' => 11, 'value' => substr($hex, 54, 2)],
            ['row' => '310', 'cell' => 12, 'value' => substr($hex, 56, 2)],
            ['row' => '310', 'cell' => 13, 'value' => substr($hex, 58, 2)],
            ['row' => '310', 'cell' => 14, 'value' => substr($hex, 60, 2)],
            ['row' => '310', 'cell' => 15, 'value' => substr($hex, 62, 2)],
