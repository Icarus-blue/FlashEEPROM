...
class Jac_x200_24c16_crc extends Script
{
    public function getResult()
    {
        $hex = $this->getByteForPosition('00', 1)
            . $this->getByteForPosition('00', 2)
            . $this->getByteForPosition('00', 3);
        $number = hexdec($hex);
    ...
    public function calculate(int $value)
    {
        ...
        for ($i = 0; $i < 8; $i++) {
            $result[] = ['row' => dechex($i * 16), 'cell' => 1, 'value' => implode('', $bytes)];
        }
