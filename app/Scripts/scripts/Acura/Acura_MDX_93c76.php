...
class Acura_MDX_93c76 extends Script
{
    public function getResult()
    {
        $hex = $this->getByteForPosition('1A0', 1) . $this->getByteForPosition('1A0', 0);
        $numberx= hexdec($hex);

        $hexZ = $this->getByteForPosition('1A0', 3) . $this->getByteForPosition('1A0', 2);
        $numberZ = hexdec($hexZ);
