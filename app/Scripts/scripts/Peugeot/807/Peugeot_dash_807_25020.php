...
class Peugeot_dash_807_25020 extends Script
{
    public function getResult()
    {
        $hex = $this->getByteForPosition('00',7). $this->getByteForPosition('00',6) . $this->getByteForPosition('10',4). $this->getByteForPosition('10',3);
        $number = hexdec($hex);
