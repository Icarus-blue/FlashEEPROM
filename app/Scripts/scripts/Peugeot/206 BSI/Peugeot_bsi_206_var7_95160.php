...
class Peugeot_bsi_206_var7_95160 extends Script
{
    ...
    public function calculate(int $value)
    {
        ...
        return [
            ...
            ['row' => '130', 'cell' => 3, 'value' => substr($hex, 4, 2)],
            ['row' => '130', 'cell' => 4, 'value' => substr($hex, 6, 2)],
            ['row' => '130', 'cell' => 7, 'value' => substr($hex, 0, 2)],
            ['row' => '130', 'cell' => 8, 'value' => substr($hex, 2, 2)],
            ['row' => '130', 'cell' => 9, 'value' => substr($hex, 4, 2)],
            ['row' => '130', 'cell' => 10, 'value' => substr($hex, 6, 2)],
