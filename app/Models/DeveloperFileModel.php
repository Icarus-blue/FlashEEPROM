...
class DeveloperFileModel extends Model
{
    protected $table = 'developerfile';
    ...
    protected $allowedFields = [
        ...
        'created_at', 'directory_type', 'imageid', 'is_template', 'script_type'
    ];
    ...
    public function createDefaultFolders(\App\Entities\User $user)
    {
        ...
        $development = $this->createFolder('Desarrollos', null, $user, DeveloperFile::DIRECTORY_SCRIPTS);
