			<article>
				...
				<p1><font face="Helvetica Neue",Helvetica,Arial,sans-serif">Los ingenieros de Flasheeprom, hemos diseñado un motor de calculo extremadamente 
					facil de usar, con una interface tan simple que en 3 pasos abras realizado el calculo. </font></p1>

					<p1><font face="Helvetica Neue",Helvetica,Arial,sans-serif">Primero tenemos crear una cuenta, de lo contrario no se te permitira descargar tu archivo.  </font></p1>	
				...
				<p1><font face="Helvetica Neue",Helvetica,Arial,sans-serif">Por ultimo, una vez que tenemos nuestro archivo editado, le damos clic en descargar y empezara nuestra descarga
