        ...
        <div class="col-7 developer-editor">
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="dev-navigation-tab" data-bs-toggle="tab"
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active developer-file-table" id="dev-navigation" role="tabpanel"
                    aria-labelledby="dev-navigation-tab">
                    <div class="file-modal-container file-modal-delete">
                        <div class="file-modal-message">
                            <form method="post" action="<?= base_url() ?>/developer/deleteFile_new">
                                <?= csrf_field(); ?>
                    ...
                    <div class="file-modal-container file-modal-rename">
                        <div class="file-modal-message">
                            <form method="post" action="<?= base_url() ?>/developer/renameFile_new">
                                <?= csrf_field(); ?>
                                <input type="hidden" class="opened-folders" name="opened">
                                <input type="hidden" class="file-id-field" name="fileid">
                                <h2>Cambiar nombre</h2>
                                <p><input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ._ -]+" name="name"
                                        class="file-name-field" required></p>
                                <p class="file-modal-buttons">
                                    <button type="button" class="btn btn-secondary">Cancelar</button>
                ...
                <div class="tab-pane fade show editor-panel" id="dev-editor-_ID_" role="tabpanel"
                    aria-labelledby="dev-editor-tab-_ID_">
                    <div>
                    ...
                    <div class="editor-buttons">
                        <button type="button" class="btn btn-primary save-script" data-id="_ID_"><i
                                class="bi-save"></i></button>
                        <button type="button" id="preview-button-_ID_" class="btn btn-primary preview-script"
                            data-id="_ID_"><i class="bi-eye"></i></button>
                    </div>
                </div>
                <div class="tab-pane fade show image-panel" id="dev-image-_ID_" role="tabpanel"
                    aria-labelledby="dev-image-tab-_ID_">
                            ...
                            <div class="result">
                                ...
                                <fieldset class="script-container script-carousel-container">
                                    ...
                                    <div class="script-normal">
                                        ...
                                        <button type="button" class="button medium-button"
                                            id="result-calculate">Escribir</button>
                                    </div>

                                    <div class="script-table">
                                        <p>Este script es de lectura de datos. Haga click en mostrar datos para realizar
                                            la lectura.</p>
                                    </div>
                                        ...
                                        <div id="script-carousel" class="carousel slide" data-bs-ride="carousel">
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <img src="<?= base_url() ?>/assets/bently.png" class="d-block w-100"
                                                        alt="">
                                                </div>
                                                <div class="carousel-item">
                                                    <img src="<?= base_url() ?>/assets/bmw.png" class="d-block w-100"
                                                        alt="">
                                                </div>
                                                <div class="carousel-item">
                                                    <img src="<?= base_url() ?>/assets/bogdan.png" class="d-block w-100"
                                                        alt="">
                                                </div>
                                            </div>
                                            <button class="carousel-control-prev" type="button"
                                                data-bs-target="#script-carousel" data-bs-slide="prev">
                                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                                <span class="visually-hidden">Anterior</span>
                                            </button>
                                            <button class="carousel-control-next" type="button"
                                                data-bs-target="#script-carousel" data-bs-slide="next">
                                ...
                                <p class="terms">
                                    <label><input type="checkbox" id="terms"> Confirmo que mi uso de este sitio está de
                                        acuerdo con los <a href="<?= base_url() ?>/home/terms">términos del servicio</a>
                                        y las leyes aplicables.</label>
                                </p>

                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button id="filename" class="nav-link active" type="button" role="tab"
                                            aria-controls="all-activity" aria-selected="true">Archivo</button>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="hextable-container">
                            <div class="expired-container">
                                <div class="expired-message">
                                    ...
                                    <p>Debe <a href="<?= base_url() ?>/user/login">iniciar sesión</a> o <a
                                            href="<?= base_url() ?>/user/register">registrarse</a>.</p>
                                    <?php endif; ?>
                                </div>
                            </div>
            ...
            <div class="action-container">
                <div id="dev-navigation-sidebar" class="action-sidebar" style="display: block">
                    ...
                    <div class="action-type" id="folder-type-1">
                        ...
                        <form method="post" action="<?= base_url() ?>/developer/newFolder_new">
                            <?= csrf_field(); ?>
                            <input type="hidden" class="current-folder" name="folderid">
                            <input type="hidden" class="opened-folders" name="opened">
                            <fieldset>
                        ...
                        <form enctype="multipart/form-data" method="post" action="<?= base_url() ?>/developer/newImage">
                            ...
                            <fieldset>
                                ...
                                <p>
                                    <label>
                                        Subir imagen:
                                        <input type="file" name="image" class="new-image-name form-control"
                ...
                <div class="action-sidebar" id="dev-editor-_ID_-sidebar">
                    <fieldset id="dev-editor-template-_ID_">
                        <legend>Script</legend>
                        <p>Este script es una plantilla de solo lectura. Su contenido se puede usar como base para
                            desarrollar nuevos scripts.</p>
                    </fieldset>
                    ...
                    <form id="dev-editor-form-_ID_" method="post" action="<?= base_url() ?>/developer/publish">
                        ...
                        <fieldset>
                            ...
                            <p>
                                <label>
                                    ...
                                    <input type="text" name="prefix" class="form-control"
                                        pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ._ -]+" required>
                                </label>
                            </p>
                            <div class="row g-0" style="margin-bottom:1rem">
                                <label class="col-md-10">
                                    Ruta de publicación:
                                    <input id="publish-folder-_ID_" type="text" name="path" class="form-control"
                                        pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ._ /-]+" readonly required>
                                </label>
                                <div class="col-md-2" style="align-self:end"><button type="button"
                                        id="folder-search-_ID_" style="min-width: 100%;margin:0;padding:0">...</button>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <p style="margin-bottom: 0">
                                    <label>
                                        <input class="publish-question" type="radio" name="question[<?= $groupid ?>]"
                                            value="<?= $question->questionid ?>" data-tokens="<?= $question->tokens ?>">
